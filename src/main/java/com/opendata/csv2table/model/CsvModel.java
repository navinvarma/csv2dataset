...
/**
 * Model to store a generic CSV file data up to 30 columns
 */
public class CsvModel {
    ...
    public void setColumn30(String column0) {
    ...
    /**
     * Generic method to get column value
     *
     * @param columnName
     * @return
     ...
     */
    public String retrieveColumnValue(String columnName) throws NoSuchFieldException, IllegalAccessException {
        // use reflection to find the column to lookup
        Field field = this.getClass().getDeclaredField(columnName);
        // get value of field requested
